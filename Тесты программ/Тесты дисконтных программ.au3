...
Local $Way = '\Лог выполнения теста\Тесты дисконтных программ.log'
...
;~ Тест 1 дисконт Бонусы-Скидка
_FileWriteLog(@ScriptDir & $Way, 'Тест 1 дисконт Бонусы-Скидка')
Sleep(2000)
...
Local $NAME_PROG = "Тестовая программа IT дисконт Бонусы-Скидка"
...
Local $TEST_PROG_RES = ControlGetText('ЦО Тест','','[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:1]')
if $TEST_PROG_RES <> 0 Then
	_FileWriteLog(@ScriptDir & $Way, 'Программа отработала, скидка бонусами равна: ' & $TEST_PROG_RES)
EndIf

if $TEST_PROG_RES == 0 or $TEST_PROG_RES == Null Then
	_FileWriteLog(@ScriptDir & $Way, 'Ошибка: Программа не дала скидку, скидка бонусами = ' & $TEST_PROG_RES)
EndIf
...
;~ Тест 2 дисконт Бонусы-Фикс знач
_FileWriteLog(@ScriptDir & $Way, 'Тест 2 дисконт Бонусы-Фикс знач')
Sleep(3000)
...
Local $NAME_PROG = "Тестовая программа IT дисконт Бонусы-Фикс знач"
Local $TEST_PROG = ControlGetText('ЦО Тест','','[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:7]')
if $TEST_PROG == $NAME_PROG Then
	_FileWriteLog(@ScriptDir & $Way, 'Программа ' & $TEST_PROG & ' отработала')
...
;~ Тест 3 дисконт Наценка
_FileWriteLog(@ScriptDir & $Way, 'Тест 3 дисконт Наценка')
Sleep(3000)
...
Local $NAME_PROG = "Тестовая программа IT дисконт Наценка"
Local $TEST_PROG = ControlGetText('ЦО Тест','','[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:7]')
if $TEST_PROG == $NAME_PROG Then
	_FileWriteLog(@ScriptDir & $Way, 'Программа ' & $TEST_PROG & ' отработала')
...
;~ Тест 4 дисконт Скидка
_FileWriteLog(@ScriptDir & $Way, 'Тест 4 дисконт Скидка')
Sleep(3000)
...
;~ Тест 5 дисконт Фикс Скидка
_FileWriteLog(@ScriptDir & $Way, 'Тест 5 дисконт Фикс Скидка')
Sleep(3000)
...
Local $NAME_PROG = "Тестовая программа IT дисконт Фикс Скидка"
Local $TEST_PROG = ControlGetText('ЦО Тест','','[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:7]')
if $TEST_PROG == $NAME_PROG Then
	_FileWriteLog(@ScriptDir & $Way, 'Программа ' & $TEST_PROG & ' отработала')
...
;~ Тест 6 дисконт Фикс Цена
_FileWriteLog(@ScriptDir & $Way, 'Тест 6 дисконт Фикс Цена')
Sleep(3000)
...
Local $NAME_PROG = "Тестовая программа IT дисконт Фикс Цена"
Local $TEST_PROG = ControlGetText('ЦО Тест','','[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:7]')
if $TEST_PROG == $NAME_PROG Then
	_FileWriteLog(@ScriptDir & $Way, 'Программа ' & $TEST_PROG & ' отработала')
