...
#ce
Local $Way = '\Лог выполнения теста\Чек реимбурсация наличка.log'
...
_FileWriteLog(@ScriptDir & $Way, 'Тип чека изменился на реимбурсацию')


#cs
добавление товара из списка реимбурсации
#ce
...
_FileWriteLog(@ScriptDir & $Way, 'Добавлен товар из списка реимбурсации')

#cs
Процедура добавления дисконтной картыи и инфо по реимбурсации.
#ce
...
_FileWriteLog(@ScriptDir & $Way, 'Добавлена карта FF440 и заполнена информация о клиенте')
