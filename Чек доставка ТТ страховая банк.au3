...
Local $Way = '\Лог выполнения теста\Чек доставка ТТ страховая банк.log'
...
send('{tab 2}')
Send(10)
_FileWriteLog(@ScriptDir & $Way, 'Заполнена франшиза 10%')
send('{tab}')
Send(0)
send('{tab}')
Send(0)
...
ControlSend("ЦО Тест", "", "[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:45]", $FIO)
_FileWriteLog(@ScriptDir & $Way, 'Заполнена данные ФИО: '& $FIO)
Sleep(400)
Local $PHONE = "0642508571"
ControlSend("ЦО Тест", "", "[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:44]", $PHONE)
_FileWriteLog(@ScriptDir & $Way, 'Заполнена данные ТЕЛЕФОН: '& $PHONE)
Sleep(400)
Local $ADDRESS = "г. Луганск ул. Будённого 59ж"
ControlSend("ЦО Тест", "", "[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:43]", $ADDRESS)
_FileWriteLog(@ScriptDir & $Way, 'Заполнена данные АДРЕС: '& $ADDRESS)
Sleep(400)
Local $TIME = "12 00"
ControlSend("ЦО Тест", "", "[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:41]", $TIME)
_FileWriteLog(@ScriptDir & $Way, 'Заполнена данные ВРЕМЯ: '& $TIME)
Sleep(400)
Local $COMMENT =  "Доставить в назначенное время"
ControlSend("ЦО Тест", "", "[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:42]", $COMMENT)
...
send('{enter}')
Sleep(400)
ControlClick("ЦО Тест", "","[CLASS:WindowsForms10.BUTTON.app.0.378734a; INSTANCE:15]")
Sleep(400)
ControlClick("ЦО Тест", "","[CLASS:WindowsForms10.BUTTON.app.0.378734a; INSTANCE:14]")
Sleep(400)
ControlClick("ЦО Тест", "","[CLASS:WindowsForms10.BUTTON.app.0.378734a; INSTANCE:12]")
Sleep(400)
Local $TTN = "87654321"
ControlSend("ЦО Тест", "", "[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:40]", $TTN)
_FileWriteLog(@ScriptDir & $Way, 'Заполнена данные ТТН: '& $TTN)
Sleep(400)
Local $PAY = "1000"
ControlSend("ЦО Тест", "", "[CLASS:WindowsForms10.EDIT.app.0.378734a; INSTANCE:39]", $PAY)
