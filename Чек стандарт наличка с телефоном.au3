...
Local $Way = '\Лог выполнения теста\Чек стандарт наличка c телефоном.log'
...
;~ Процедура добавления дисконтной карты по номеру телефона
...
Exit
EndIf
_FileWriteLog(@ScriptDir & $Way, 'Добавлен тестовый мобильный телефон 380990631560')
