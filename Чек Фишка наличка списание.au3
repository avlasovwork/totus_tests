...
#ce
Local $Way = '\Лог выполнения теста\Чек фишка наличка списание.log'
...
_FileWriteLog(@ScriptDir & $Way, 'Списано 12 бонусов фишка')
...
_FileWriteLog(@ScriptDir & $Way, 'Пробит чек фишка')
